.. zephyr:code-sample:: is31fl3743
   ...
   Control a matrix of up to 192 LEDs connected to an IS31FL3743 driver chip.
...
(:file:`boards/frdm_k22f.overlay`). It assumes that the IS31FL3743 LED
controller is connected to I2C0, at address 0x20. The SDB GPIO should be
