...
#ifndef ZEPHYR_INCLUDE_DRIVERS_LED_IS31FL3741_H_
#define ZEPHYR_INCLUDE_DRIVERS_LED_IS31FL3741_H_

/**
 * @brief Blanks IS31FL3741 LED display.
 *
 ...
 *
 * Sets the PWM frequency for the LED driver.
 * See table 14 of the datasheet for additional details.
 * @param dev: LED device structure
 * @param limit: pwm frequency to set
 * @return 0 on success, or negative value on error.
 */
 ...
 * to the following formula: (383/R_ISET) * (limit/256)
 * See table 14 of the datasheet for additional details.
 * @param dev: LED device structure
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_LED_IS31FL3741_H_ */
